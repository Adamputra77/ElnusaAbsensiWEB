      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div className="xl:col-span-2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-5 backdrop-blur-xl flex flex-col h-[200px] lg:h-[350px]">
              ...
              <div className="flex-1 bg-slate-950 border border-slate-900 rounded-xl relative overflow-hidden flex items-center justify-center p-2 group">
                ...
                <div className="hidden lg:block absolute top-2 left-2 text-[9px] font-mono text-slate-500 leading-none">
            ...
            <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-5 backdrop-blur-xl flex flex-col h-[250px] lg:h-[350px]">
          ...
          <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-5 backdrop-blur-xl h-[250px] lg:h-[330px] flex flex-col shadow-2xl">
        ...
        <div className="xl:col-span-1 flex flex-col gap-6">
          ...
          <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-5 backdrop-blur-xl flex flex-col h-[250px] lg:h-[350px] shadow-2xl">
            <h2 className="text-xs font-black uppercase text-cyan-400 tracking-wider mb-4 flex items-center gap-2 shrink-0">
              <Clock size={14} />
          ...
          <div className="hidden lg:flex bg-slate-900/40 border border-slate-800/80 rounded-2xl p-5 backdrop-blur-xl flex-col flex-1 shadow-2xl relative overflow-hidden">
            {/* Accent Corner Decor */}
